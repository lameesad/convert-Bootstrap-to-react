                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="service text-center service-2 padding-none cleaning-service mb-30">
                    ...
                    <div class="content">
                      ...
                      <a class="readmore_btn btn-transparent" href="#">
                        READ MORE
                      </a>
                    </div>
                  </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="service text-center service-2 padding-none cleaning-service  mb-30">
                    <div class="thumb">
                      <a href="#">
                        <img
                          src="assets/images/serviece/service-02.jpg"
                          alt="service img"
                        />
                      </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="service text-center service-2 padding-none cleaning-service  mb-30">
                    <div class="thumb">
                      <a href="#">
                        <img
                          src="assets/images/serviece/service-03.jpg"
                          alt="service img"
                        />
                      </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="service text-center service-2 padding-none cleaning-service  mb-30">
                    <div class="thumb">
                      <a href="#">
                        <img
                          src="assets/images/serviece/service-04.jpg"
                          alt="service img"
                        />
                      </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="service text-center service-2 padding-none cleaning-service  mb-30">
                    <div class="thumb">
                      <a href="#">
                        <img
                          src="assets/images/serviece/service-05.jpg"
                          alt="service img"
                        />
                      </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="service text-center service-2 padding-none cleaning-service  mb-30">
                    <div class="thumb">
                      <a href="#">
                        <img
                          src="assets/images/serviece/service-06.jpg"
                          alt="service img"
                        />
                      </a>
                    </div>
